<?php
global $porto_settings, $page_share, $porto_blog_columns, $porto_post_style, $post;
...
elseif ( 'hover_info' == $post_style || 'hover_info2' == $post_style ) :
	...
	<div class="grid-box">
		...
		<div class="post-content">
			...
			<h4 aria-level="2" class="entry-title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h4>
			<?php
