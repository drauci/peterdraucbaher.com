...
<?php if ( ! $b['thumb-padding'] ) : ?>
	div.thumb-info, span.thumb-info { border-width: 0 }
<?php endif; ?>
...
<?php
	...
	$main_menu_level1_active_color = $b['mainmenu-toplevel-config-active'] ? $b['mainmenu-toplevel-alink-color'] : ( empty( $b['mainmenu-toplevel-link-color']['hover'] ) ? '' : $b['mainmenu-toplevel-link-color']['hover'] );
?>
