...
?>
<div id="footer" class="footer footer-3<?php echo ! $porto_settings['footer-ribbon'] ? '' : ' show-ribbon'; ?>"
<?php
				...
				if ( $cols ) :
					...
					switch ( $cols ) {
						case 1:
							...
							break;
						case 2:
							$col_class[1] = 'col-lg-' . ( ( ! empty( $porto_settings['footer-customize'] ) && $porto_settings['footer-widget1'] ) ? $porto_settings['footer-widget1'] : '9' );
