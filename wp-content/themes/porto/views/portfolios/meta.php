...
if ( isset( $porto_settings['portfolio-metas'] ) && ( ( in_array( 'link', $porto_settings['portfolio-metas'] ) && $portfolio_link ) || ( in_array( 'skills', $porto_settings['portfolio-metas'] ) && $skill_list ) || ( in_array( 'location', $porto_settings['portfolio-metas'] ) && $portfolio_location ) || ( in_array( 'client', $porto_settings['portfolio-metas'] ) && $portfolio_client ) ) ) :
	?>
	<?php if ( is_single() ) : ?>
	<<?php echo isset( $title_tag ) ? esc_html( $title_tag ) : 'h5'; ?> aria-level="4" class="portfolio-details-title <?php echo isset( $title_class ) ? esc_attr( $title_class ) : 'm-t-lg'; ?>"><?php echo porto_strip_script_tags( sprintf( __( '%s <strong>Details</strong>', 'porto' ), $portfolio_name ) ); ?></<?php echo isset( $title_tag ) ? esc_html( $title_tag ) : 'h5'; ?>>
<?php endif; ?>
