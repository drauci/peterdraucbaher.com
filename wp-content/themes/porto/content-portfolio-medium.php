	...
	<div class="portfolio-title<?php echo ( 'widewidth' === $porto_layout ? ' container m-t-lg' : '' ); ?>">
		<div class="row">
			...
			<div class="portfolio-nav col-lg-1">
				<?php
				previous_post_link( '%link', '<div data-bs-tooltip title="' . esc_attr__( 'Previous', 'porto' ) . '" class="portfolio-nav-prev" aria-label="prev"><i class="fa"></i></div>' );
	...
	<div class="row<?php echo ( 'widewidth' === $porto_layout ? ' m-t-lg' : '' ); ?>">
		...
		<?php endif; ?>
			...
			if ( get_the_content() ) :
				...
				<h5 class="inline-block portfolio-desc" aria-level="3"><?php echo porto_strip_script_tags( sprintf( __( '%s <strong>Description</strong>', 'porto' ), $portfolio_name ) ); ?></h5><?php endif; ?>
