<?php
global $porto_settings, $prev_post_year, $prev_post_month, $first_timeline_loop, $post_count, $post, $porto_post_style, $page_share, $post;
...
if ( $prev_post_month != $post_month || ( $prev_post_month == $post_month && $prev_post_year != $post_year ) ) :
	$post_count = 1;
	?>
	<div class="timeline-date"><h3 aria-level="2"><?php echo get_the_date( 'F Y' ); ?></h3></div>
<?php endif; ?>
<?php
...
if ( isset( $porto_settings['post-metas'] ) && in_array( 'comments', $porto_settings['post-metas'] ) && ( ! isset( $post->comment_status ) || 'open' == $post->comment_status ) ) {
	...
	<article <?php post_class( $post_class ); ?>>
		...
		<!-- Post meta before content -->
			...
			<div class="post-content">
				<h4 aria-level="3" class="entry-title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h4>
				<?php
