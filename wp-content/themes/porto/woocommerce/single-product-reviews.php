		...
		<div id="review_form_wrapper">
			<div id="review_form">
				...
				if ( ( function_exists( 'wc_review_ratings_enabled' ) && wc_review_ratings_enabled() ) || ( ! function_exists( 'wc_review_ratings_enabled' ) && 'yes' === get_option( 'woocommerce_enable_review_rating' ) ) ) {
					$comment_form['comment_field'] = '<div class="comment-form-rating"><label id="comment-form-rating-label" for="rating">' . esc_html__( 'Your rating', 'woocommerce' ) . ( function_exists( 'wc_review_ratings_enabled' ) && wc_review_ratings_enabled() ? '&nbsp;<span class="required">*</span>' : '' ) . '</label><select name="rating" id="rating" required>
