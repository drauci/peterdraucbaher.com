...
?>
<h3 class="account-sub-title d-none d-md-block mb-3 mt-2"><i class="porto-icon-package align-middle m-r-sm"></i><?php printf( esc_html__( 'Order #%s', 'woocommerce' ), esc_html( $order->get_order_number() ) ); ?></h3>
			...
			<div class="woocommerce-OrderUpdate-inner comment_container">
				<div class="woocommerce-OrderUpdate-text comment-text">
					...
					<div class="woocommerce-OrderUpdate-description description">
						<?php echo function_exists( 'porto_shortcode_format_content' ) ? porto_shortcode_format_content( $note->comment_content ) : wp_kses_post( wpautop( wptexturize( $note->comment_content ) ) ); ?>
					</div>
