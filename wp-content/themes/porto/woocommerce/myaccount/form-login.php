...
<div class="<?php echo ( true == $lightbox ? '' : ( 'no' === get_option( 'woocommerce_enable_myaccount_registration' ) ? esc_html( 'col-md-6 mx-auto mb-4' ) : esc_html( 'col-lg-10 mx-auto mb-4' ) ) ); ?>">
	...
	<div class="align-left <?php echo ( true == $lightbox ? esc_html( 'featured-box' ) : '' ); ?>">
		<div class="box-content">
			...
			<?php endif; ?>
					<form class="woocommerce-form woocommerce-form-login login <?php echo false === $lightbox && 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ? 'pr-lg-4 pe-0' : ''; ?>" method="post" novalidate>
						...
						<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
							...
							<input type="text" class="woocommerce-Input woocommerce-Input--text input-text line-height-xl" name="username" id="username" autocomplete="username" value="<?php echo ( ! empty( $_POST['username'] ) && is_string( $_POST['username'] ) ) ? esc_attr( wp_unslash( $_POST['username'] ) ) : ''; ?>" required aria-required="true" /><?php // @codingStandardsIgnoreLine ?>
						</p>
