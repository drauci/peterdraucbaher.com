...
if ( ( function_exists( 'wc_get_loop_prop' ) && ! wc_get_loop_prop( 'is_paginated' ) ) || isset( $porto_woocommerce_loop['view'] ) || ! isset( $_REQUEST['gridcookie'] ) || 'list' != $_REQUEST['gridcookie'] ) {
...
<li role="none" <?php wc_product_class( $classes, $product ); ?>>
<div class="product-inner">
	...
	<div class="product-image">
		...
		<a <?php echo porto_filter_output( $more_target ); ?> href="<?php echo esc_url( $more_link ); ?>" aria-label="<?php esc_attr_e( 'Go to product page', 'porto' ); ?>">
			<?php
				if ( $product->is_type( 'variable' ) ) {
					remove_action( 'woocommerce_before_shop_loop_item_title', 'porto_woocommerce_sale_product_period', 20 );
				}
				/**
