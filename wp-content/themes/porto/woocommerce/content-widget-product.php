...
<li>
	...
	<a aria-label="<?php esc_attr_e( 'Go to product page', 'porto' ); ?>" class="product-image" href="<?php echo esc_url( get_permalink( $product->get_id() ) ); ?>" title="<?php echo esc_attr( $product->get_name() ); ?>">
