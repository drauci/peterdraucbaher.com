						...
						<table class="shop_table responsive cart cart-table woocommerce-cart-form__contents" cellspacing="0">
							<thead>
								<tr>
									...
									<th scope="col" class="product-name"><span><?php esc_html_e( 'Product', 'woocommerce' ); ?></span></th>
									<th scope="col" class="product-price"><span><?php esc_html_e( 'Price', 'woocommerce' ); ?></span></th>
									<th scope="col" class="product-quantity"><span><?php esc_html_e( 'Quantity', 'woocommerce' ); ?></span></th>
									<th scope="col" class="product-subtotal text-center text-md-right"><span><?php esc_html_e( 'Subtotal', 'woocommerce' ); ?></span></th>
								</tr>
							</thead>
							<tbody>
											...
											<td class="product-thumbnail">
												<div class="position-relative">
													...
													echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
														...
														sprintf(
															'<a role="button" href="%s" class="remove remove-product position-absolute" aria-label="%s" data-product_id="%s" data-product_sku="%s" data-cart_id="%s"></a>',
								...
								<tr>
									<td colspan="6" class="actions px-md-2">
											...
											<div class="cart_totals_toggle">
												<div id="panel-cart-discount" class="d-sm-flex justify-content-between align-items-start">
													<div class="coupon">
												...
												<?php endif; ?>
													...
													<button type="submit" class="button wc-action-btn wc-action-sm<?php esc_attr_e( ! empty( $porto_settings['auto-update-cart'] ) ? ' update-button-hidden' : '' ) ?>" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
												</div>
											</div>
