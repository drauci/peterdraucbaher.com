...
if ( $cross_sells && $porto_settings['product-crosssell'] ) : ?>
	...
	<div class="cross-sells">
		...
		<div class="slider-wrapper">
			...
			$porto_woocommerce_loop['columns'] = isset( $porto_settings['product-related-cols'] ) ? $porto_settings['product-related-cols'] : ( isset( $porto_settings['product-cols'] ) ? $porto_settings['product-cols'] : 4 );
