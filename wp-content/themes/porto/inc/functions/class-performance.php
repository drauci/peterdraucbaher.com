...
if ( ! class_exists( 'Porto_Performance' ) ) :
	class Porto_Performance {
		...
		public function __construct() {
			...
			if ( ! empty( $porto_settings_optimize['mobile_disable_animation'] ) && wp_is_mobile() ) {
				add_filter( 'body_class', array( $this, 'add_body_class_animate' ) );
			}
		...
		/**
		 * Add body class for disable animation.
		 *
		 * @since 7.2.0
		 */
		public function add_body_class_animate( $classes ) {
			$classes[] = 'porto-dm-animate'; //disable animation
			return $classes;
		}		
