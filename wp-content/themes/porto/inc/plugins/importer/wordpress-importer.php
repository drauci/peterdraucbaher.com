	...
	<p class="submit"><input type="submit" class="button" value="<?php esc_attr_e( 'Submit', 'porto' ); ?>" /></p>
		...
		function process_posts() {
			...
			foreach ( $this->posts as $post ) {
				...
				if ( isset( $_POST['one_import'] ) && 'true' == $_POST['one_import'] && isset( $import_types[ $post['post_type'] ] ) && $import_types[ $post['post_type'] ] ) {
					continue;
				}
				...
				*/
				...
				if ( $post_exists && get_post_type( $post_exists ) == $post['post_type'] ) {
					...
					if ( 'page' == $post['post_type'] || 'block' == $post['post_type'] || 'porto_builder' == $post['post_type'] || 'member' == $post['post_type'] || 'portfolio' == $post['post_type'] || 'event' == $post['post_type'] || 'post' == $post['post_type'] || 'faq' == $post['post_type'] || 'service' == $post['post_type'] || 'product' == $post['post_type'] ) {
				...
				if (  isset( $_POST['one_import'] ) && 'true' == $_POST['one_import'] && isset( $import_types[ $post['post_type'] ] ) ) {
					if ( $post['status'] == 'publish' ) {
						$import_types[ $post['post_type'] ] ++;
					}
				}
