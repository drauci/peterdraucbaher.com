...
if ( defined( 'WP_ROCKET_VERSION' ) ) {
	include_once PORTO_PLUGINS . '/compatibility/class-porto-rocket-compatibility.php';
}
 ...
 * @since 7.7.0
 */
if ( defined( 'LSCWP_V' ) && defined( 'PORTO_FUNC_VERSION' ) ) {
	include_once PORTO_PLUGINS . '/compatibility/class-porto-lite-compatibility.php';
}
...
if ( class_exists( 'Ivole' ) ) {
	include_once PORTO_PLUGINS . '/compatibility/class-porto-curs-compatibility.php';
}
 ...
 * @since 7.5.0
 */
if ( class_exists( 'WooCommerce' ) && defined( 'YITH_WCAN' ) ) {
	include_once PORTO_PLUGINS . '/compatibility/class-porto-yith-wcan-compatibility.php';
}
...
if ( ( current_user_can( 'manage_options' ) && wp_doing_ajax() ) || ( is_admin() && ! is_customize_preview() ) ) {
	class PortoTGMPlugins {
		...
		protected $plugins = array(
			...
			array(
				'name'       => 'CommerceBird – WooCommerce Inventory Management and AI Platform',
				'slug'       => 'commercebird',
				'required'   => false,
				'url'        => 'commercebird/commercebird.php',
				'image_url'  => PORTO_PLUGINS_URI . '/images/commercebird.png',
				'visibility' => 'hidden',
			),			
			array(
			...
			array(
				...
				'required'   => false,
				'url'        => 'yith-woocommerce-frequently-bought-together/init.php',
				'image_url'  => PORTO_PLUGINS_URI . '/images/yith_fbt.png',
				'visibility' => 'hidden',
			),			
			array(
				...
				$this->plugins = array_merge(
					...
					array(
						array(
							...
							'url'       => 'geodirectory-porto-theme-compatibility-pack/geodir_porto_compatibility.php',
