...
<article <?php post_class( $post_class ); ?>>
	...
	<div class="portfolio-title<?php echo 'widewidth' === $porto_layout ? ' container m-t-lg' : ''; ?>">
		<div class="row">
			<div class="portfolio-nav-all col-lg-1">
				<a role="button" aria-label="<?php esc_attr_e( 'Back to list', 'porto' ); ?>" title="<?php esc_attr_e( 'Back to list', 'porto' ); ?>" data-bs-tooltip href="<?php echo esc_url( get_post_type_archive_link( 'portfolio' ) ); ?>"><i class="fas fa-th"></i></a>
			</div>
	...
	<div class="row<?php echo 'widewidth' === $porto_layout ? ' m-t-lg' : ''; ?> portfolio-container">
									...
									<span class="thumb-info<?php echo empty( $porto_settings['portfolio-zoom'] ) ? ' thumb-info-lighten' : ''; ?> thumb-info-centered-icons thumb-info-no-borders">
										<span class="thumb-info-wrapper">
											...
											<?php if ( ! empty( $porto_settings['portfolio-zoom'] ) ) : ?>
												...
												<a aria-label="<?php esc_attr_e( 'Go to portfolio page', 'porto' ); ?>" href="<?php echo esc_url( $attachment['src'] ); ?>" class="lightbox-portfolio">
		...
		<?php endif; ?>
			...
			<div data-plugin-sticky data-plugin-options="<?php echo esc_attr( '{"autoInit": true, "minWidth": 992, "containerSelector": ".portfolio-container"}' ); ?>">
			<?php endif; ?>
			...
			if ( get_the_content() ) :
				...
				<h5 class="portfolio-desc" aria-level="3"><?php printf( porto_strip_script_tags( __( '%s <strong>Description</strong>', 'porto' ) ), esc_html( $portfolio_name ) ); ?></h5><?php endif; ?>
