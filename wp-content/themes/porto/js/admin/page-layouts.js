...
( function ( $ ) {
	if ( $( '.page-layouts' ).length ) {
		$( 'body' ).on( 'click', '.layout-box .layout-part', function () {
			...
			$this.closest( '.layout-box' ).find( '.layout-header .pg-layout-title' ).text( $this.text().trim() );
			...
			var $pgLayoutTitle = $this.closest( '.layout-box' ).find( '.layout-header .pg-layout-title' );
			$pgLayoutTitle.text( $pgLayoutTitle.data( 'raw-title' ) );
