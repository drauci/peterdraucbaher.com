...
<article class="custom-post-event post-event-list custom-sm-margin-bottom-2">
	...
	<?php endif; ?>
		...
		<h4 aria-level="3" class="font-weight-bold text-color-dark"> <a href="<?php the_permalink(); ?>" class="text-decoration-none custom-secondary-font text-color-dark"> <?php the_title(); ?> </a> </h4>
		<?php
